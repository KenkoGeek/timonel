...
export class ConfigurationLoader {
  ...
  async loadPluginConfiguration(
    ...
    this.logger.info('Plugin configuration loaded', {
      ...
      validated,
      hasErrors: validationErrors !== undefined,
   ...
   */
  async loadEnvironmentConfiguration(environment: string): Promise<EnvironmentConfiguration | undefined> {
   ...
   * @private
   */
  private loadEnvironmentVariableConfiguration(pluginName: string): Record<string, unknown> | undefined {
    if (!pluginName) {
      return undefined;
    }
   ...
   * @private
   */
  private async loadEnvironmentFromFiles(environment: string): Promise<EnvironmentConfiguration | undefined> {
    // For now, return undefined as file loading is not implemented
